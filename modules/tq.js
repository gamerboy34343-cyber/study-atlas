...
function renderHome(){
  ...
  app.innerHTML = `${Topbar()}<main>
    <div class="card" style="text-align:center">
      ...
      <p style="color:var(--muted);max-width:520px;margin:0 auto">Explore ten themed worlds. Unlock lessons. Turn Class 8 grammar into a beautiful, cinematic journey.</p>
